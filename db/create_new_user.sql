...
CREATE OR REPLACE FUNCTION public.create_new_user(p_username character varying, p_password_char character, p_display_name character varying, p_player_mode character varying DEFAULT 'adulte')
